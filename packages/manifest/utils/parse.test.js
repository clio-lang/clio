...
const githubZip_branch = 'https://github.com/clio-lang/rethinkdb/archive/my-branch.zip';
const githubZip_version = 'https://github.com/clio-lang/rethinkdb/archive/v2.3.3.zip';
