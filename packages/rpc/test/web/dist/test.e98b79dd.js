...
parcelRequire = (function (modules, cache, entry, globalName) {
...
})(
  {
      ...
      function (require, module, exports) {
        ...
        class Dispatcher extends EventEmitter {
          ...
          addTransport(transport) {
            ...
            transport.on("registerWorker", (...args) =>
              this.registerWorker(...args)
            );
            transport.start();
          }
          ...
          registerWorker(worker, { paths }, id) {
            for (const path of paths)
              this.workers.set(path, [
                ...(this.workers.get(path) || []),
                worker,
              ]);
    ...
    "../../transports/web-worker/socket.js": [
      function (require, module, exports) {
        const { EventEmitter } = require("../../common");
    ...
    "../../transports/web-worker/server.js": [
      function (require, module, exports) {
      ...
      {
        "./socket": "../../transports/web-worker/socket.js",
        "../../common": "../../common.js",
      },
    ],
    "../../transports/web-worker/client.js": [
      function (require, module, exports) {
        const { EventEmitter } = require("../../common");
    ...
    "../../transports/web-worker/index.js": [
      function (require, module, exports) {
      ...
      {
        "./server": "../../transports/web-worker/server.js",
        "./client": "../../transports/web-worker/client.js",
      },
    ],
    "test.js": [
      function (require, module, exports) {
      ...
      },
      {
        ...
        "../../transports/web-worker": "../../transports/web-worker/index.js",
        "./worker.js": [
          ["worker.ab30da2c.js", "worker.js"],
          "worker.ab30da2c.js.map",
          "worker.js",
        ],
      },
    ],
    "../../../../../../opt/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js": [
      function (require, module, exports) {
