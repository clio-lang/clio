...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text$1(t0_value);
			t1 = space$1();
			add_location$1(h4, file, 56, 10, 1430);
			...
			add_location$1(a, file, 51, 8, 1292);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location$1(h3, file, 49, 6, 1232);
			attr_dev$1(div0, "class", "sticky svelte-1rp6xr7");
			add_location$1(div0, file, 48, 4, 1205);
			attr_dev$1(div1, "class", "headnav svelte-1rp6xr7");
			add_location$1(div1, file, 47, 2, 1179);
...
function instance($$self, $$props, $$invalidate) {
	...
	const getComponent = meta => () => {
		return import('./index-2e49d79f.js');
	};
...
//# sourceMappingURL=main-9b6891fc.js.map
