...
function dynamicImport(path) {
  switch (path) {
    ...
    case "./routes/v0.9.0/index.svelte":
      return import('./index-086b7feb.js');
  }
}
...
// (58:6) <Loadable loader={getComponent(meta)} let:component>
function create_default_slot_1(ctx) {
	...
	var switch_value = /*component*/ ctx[17];
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (switch_value !== (switch_value = /*component*/ ctx[17])) {
				if (switch_instance) {
					group_outros();
					const old_component = switch_instance;
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(58:6) <Loadable loader={getComponent(meta)} let:component>",
		ctx
	});
...
function create_default_slot(ctx) {
	...
	loadable = new Loadable({
			props: {
				loader: /*getComponent*/ ctx[6](/*meta*/ ctx[16]),
				$$slots: {
					default: [
						create_default_slot_1,
						({ component }) => ({ 17: component }),
						({ component }) => component ? 131072 : 0
					]
				},
				$$scope: { ctx }
			},
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*meta*/ 65536) loadable_changes.loader = /*getComponent*/ ctx[6](/*meta*/ ctx[16]);

			if (dirty & /*$$scope, component, sections*/ 393218) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(57:4) <Route path=\\\"/*\\\" let:meta>",
		ctx
	});
...
// (66:6) {#each sections as section}
function create_each_block(ctx) {
	let a;
	let h4;
	let t0_value = /*section*/ ctx[13] + "";
	let t0;
	let t1;
	let a_href_value;
	...
	const block = {
		c: function create() {
			...
			t0 = text(t0_value);
			t1 = space();
			add_location(h4, file, 71, 10, 1903);
			attr_dev(a, "href", a_href_value = "#" + /*slug*/ ctx[5](/*section*/ ctx[13]));
			attr_dev(a, "tinro-ignore", "");
			attr_dev(a, "class", "svelte-1rp6xr7");
			toggle_class(a, "active", /*$currentSection*/ ctx[3] == /*slug*/ ctx[5](/*section*/ ctx[13]));
			add_location(a, file, 66, 8, 1765);
		},
		m: function mount(target, anchor) {
			insert_dev(target, a, anchor);
			append_dev(a, h4);
		...
		p: function update(ctx, dirty) {
			if (dirty & /*sections*/ 2 && t0_value !== (t0_value = /*section*/ ctx[13] + "")) set_data_dev(t0, t0_value);

			if (dirty & /*sections*/ 2 && a_href_value !== (a_href_value = "#" + /*slug*/ ctx[5](/*section*/ ctx[13]))) {
				attr_dev(a, "href", a_href_value);
			}

			if (dirty & /*$currentSection, slug, sections*/ 42) {
				toggle_class(a, "active", /*$currentSection*/ ctx[3] == /*slug*/ ctx[5](/*section*/ ctx[13]));
			}
		},
		d: function destroy(detaching) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(66:6) {#each sections as section}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(main, file, 55, 2, 1452);
			attr_dev(h3, "class", "svelte-1rp6xr7");
			add_location(h3, file, 64, 6, 1705);
			attr_dev(div0, "class", "sticky svelte-1rp6xr7");
			add_location(div0, file, 63, 4, 1678);
			attr_dev(div1, "class", "headnav svelte-1rp6xr7");
			add_location(div1, file, 62, 2, 1652);
			attr_dev(div2, "class", "page svelte-1rp6xr7");
			add_location(div2, file, 53, 0, 1386);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, meta, sections*/ 327682) {
				route_changes.$$scope = { dirty, ctx };
			}

			route.$set(route_changes);

			if (dirty & /*slug, sections, $currentSection*/ 42) {
...
function instance($$self, $$props, $$invalidate) {
	...
	const setMetaVariant = variant => {
		if (variant) dynamicImport(`./meta/${variant}.json`).then(data => data.default).then(meta => metaVariant = meta);
	};
	...
	$$self.$inject_state = $$props => {
		...
		if ("currentVariant" in $$props) $$invalidate(0, currentVariant = $$props.currentVariant);
		if ("metaVariant" in $$props) metaVariant = $$props.metaVariant;
...
//# sourceMappingURL=main-10274ee6.js.map
