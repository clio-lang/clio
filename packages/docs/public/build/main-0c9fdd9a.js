...
function dynamicImport(path) {
  switch (path) {
    ...
    case "./routes/v0.9.0/index.svelte":
      return import('./index-3a5dcf05.js');
  }
}
...
// (54:6) <Loadable loader={getComponent(meta)} let:component>
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(54:6) <Loadable loader={getComponent(meta)} let:component>",
		ctx
	});
...
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(53:4) <Route path=\\\"/*\\\" let:meta>",
		ctx
	});
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text(t0_value);
			t1 = space();
			add_location(h4, file, 67, 10, 1823);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(62:6) {#each sections as section}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(main, file, 51, 2, 1372);
			attr_dev(h3, "class", "svelte-1rp6xr7");
			add_location(h3, file, 60, 6, 1625);
			attr_dev(div0, "class", "sticky svelte-1rp6xr7");
			add_location(div0, file, 59, 4, 1598);
			attr_dev(div1, "class", "headnav svelte-1rp6xr7");
			add_location(div1, file, 58, 2, 1572);
			attr_dev(div2, "class", "page svelte-1rp6xr7");
			add_location(div2, file, 49, 0, 1306);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	const getComponent = () => async () => {
		...
		console.log({ meta });
		return await import('./index-3a5dcf05.js');
	};
...
//# sourceMappingURL=main-0c9fdd9a.js.map
