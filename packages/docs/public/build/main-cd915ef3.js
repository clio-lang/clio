...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text$1(t0_value);
			t1 = space$1();
			add_location$1(h4, file, 58, 10, 1473);
			...
			add_location$1(a, file, 53, 8, 1335);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location$1(main, file, 44, 2, 1115);
			attr_dev$1(h3, "class", "svelte-1rp6xr7");
			add_location$1(h3, file, 51, 6, 1275);
			attr_dev$1(div0, "class", "sticky svelte-1rp6xr7");
			add_location$1(div0, file, 50, 4, 1248);
			attr_dev$1(div1, "class", "headnav svelte-1rp6xr7");
			add_location$1(div1, file, 49, 2, 1222);
			attr_dev$1(div2, "class", "page svelte-1rp6xr7");
			add_location$1(div2, file, 42, 0, 1069);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	const getComponent = async meta => {
		return await import('./index-d7d86cdc.js');
	};
...
//# sourceMappingURL=main-cd915ef3.js.map
