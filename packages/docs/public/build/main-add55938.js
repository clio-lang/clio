...
function create_default_slot(ctx) {
	...
	function loadable_sections_binding(value) {
		/*loadable_sections_binding*/ ctx[7](value);
	}
	...
	if (/*sections*/ ctx[0] !== void 0) {
		loadable_props.sections = /*sections*/ ctx[0];
	}

	loadable = new Loadable({ props: loadable_props, $$inline: true });
	binding_callbacks$1.push(() => bind(loadable, "sections", loadable_sections_binding));
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (!updating_sections && dirty & /*sections*/ 1) {
				...
				loadable_changes.sections = /*sections*/ ctx[0];
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text$1(t0_value);
			t1 = space$1();
			add_location$1(h4, file, 58, 10, 1536);
			...
			add_location$1(a, file, 53, 8, 1398);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location$1(main, file, 44, 2, 1161);
			attr_dev$1(h3, "class", "svelte-1rp6xr7");
			add_location$1(h3, file, 51, 6, 1338);
			attr_dev$1(div0, "class", "sticky svelte-1rp6xr7");
			add_location$1(div0, file, 50, 4, 1311);
			attr_dev$1(div1, "class", "headnav svelte-1rp6xr7");
			add_location$1(div1, file, 49, 2, 1285);
			attr_dev$1(div2, "class", "page svelte-1rp6xr7");
			add_location$1(div2, file, 42, 0, 1115);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, meta, sections*/ 6145) {
...
function instance($$self, $$props, $$invalidate) {
	...
	const getComponent = meta => () => {
		console.log({ meta });
		import('./index-3ff0ccb0.js').then(console.log);
		return import('./index-3ff0ccb0.js');
	};
...
export { append_dev as A, action_destroyer as B, set_data_dev as C, toggle_class as D, create_slot as E, update_slot as F, null_to_empty as G, global$1 as H, getAugmentedNamespace as I, globals as J, listen_dev as K, empty as L, setContext as M, tabsContext as N, writable$1 as O, set_style as P, app as Q, SvelteComponentDev as S, validate_store as a, component_subscribe as b, commonjsGlobal as c, dispatch_dev as d, set_store_value as e, create_component as f, getContext as g, transition_out as h, init as i, destroy_component as j, keys as k, space as l, mount_component as m, noop as n, onMount as o, element as p, attr_dev as q, add_location as r, safe_not_equal as s, transition_in as t, insert_dev as u, validate_slots as v, group_outros as w, check_outros as x, detach_dev as y, text as z };
//# sourceMappingURL=main-add55938.js.map
