...
function dynamicImport(path) {
  switch (path) {
    case "./meta/v0.9.0.json":
      return import('./v0.9.0-0dceb180.js');
    case "./routes/v0.9.0/index.svelte":
      return import('./index-7ea857e4.js');
  }
}
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text(t0_value);
			t1 = space();
			add_location(h4, file, 74, 10, 2001);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(main, file, 56, 2, 1508);
			attr_dev(h3, "class", "svelte-1rp6xr7");
			add_location(h3, file, 67, 6, 1803);
			attr_dev(div0, "class", "sticky svelte-1rp6xr7");
			add_location(div0, file, 66, 4, 1776);
			attr_dev(div1, "class", "headnav svelte-1rp6xr7");
			add_location(div1, file, 65, 2, 1750);
			attr_dev(div2, "class", "page svelte-1rp6xr7");
			add_location(div2, file, 54, 0, 1442);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=main-2a4365a3.js.map
