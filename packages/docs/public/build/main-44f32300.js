...
function dynamicImport(path) {
  switch (path) {
    ...
    case "./routes/v0.9.0/index.svelte":
      return import('./index-fde6e3d5.js');
  }
}
...
// (52:6) <Loadable loader={getComponent(meta)} let:component>
function create_default_slot_1(ctx) {
	...
	var switch_value = /*component*/ ctx[15];
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (switch_value !== (switch_value = /*component*/ ctx[15])) {
				if (switch_instance) {
					group_outros();
					const old_component = switch_instance;
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(52:6) <Loadable loader={getComponent(meta)} let:component>",
		ctx
	});
...
function create_default_slot(ctx) {
	...
	loadable = new Loadable({
			props: {
				loader: /*getComponent*/ ctx[6](/*meta*/ ctx[14]),
				$$slots: {
					default: [
						create_default_slot_1,
						({ component }) => ({ 15: component }),
						({ component }) => component ? 32768 : 0
					]
				},
				$$scope: { ctx }
			},
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*meta*/ 16384) loadable_changes.loader = /*getComponent*/ ctx[6](/*meta*/ ctx[14]);

			if (dirty & /*$$scope, component, sections*/ 98306) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(51:4) <Route path=\\\"/*\\\" let:meta>",
		ctx
	});
...
// (60:6) {#each sections as section}
function create_each_block(ctx) {
	let a;
	let h4;
	let t0_value = /*section*/ ctx[11] + "";
	let t0;
	let t1;
	let a_href_value;
	...
	const block = {
		c: function create() {
			...
			t0 = text(t0_value);
			t1 = space();
			add_location(h4, file, 65, 10, 1780);
			attr_dev(a, "href", a_href_value = "#" + /*slug*/ ctx[5](/*section*/ ctx[11]));
			attr_dev(a, "tinro-ignore", "");
			attr_dev(a, "class", "svelte-1rp6xr7");
			toggle_class(a, "active", /*$currentSection*/ ctx[3] == /*slug*/ ctx[5](/*section*/ ctx[11]));
			add_location(a, file, 60, 8, 1642);
		},
		m: function mount(target, anchor) {
			insert_dev(target, a, anchor);
			append_dev(a, h4);
		...
		p: function update(ctx, dirty) {
			if (dirty & /*sections*/ 2 && t0_value !== (t0_value = /*section*/ ctx[11] + "")) set_data_dev(t0, t0_value);

			if (dirty & /*sections*/ 2 && a_href_value !== (a_href_value = "#" + /*slug*/ ctx[5](/*section*/ ctx[11]))) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(60:6) {#each sections as section}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(main, file, 49, 2, 1329);
			attr_dev(h3, "class", "svelte-1rp6xr7");
			add_location(h3, file, 58, 6, 1582);
			attr_dev(div0, "class", "sticky svelte-1rp6xr7");
			add_location(div0, file, 57, 4, 1555);
			attr_dev(div1, "class", "headnav svelte-1rp6xr7");
			add_location(div1, file, 56, 2, 1529);
			attr_dev(div2, "class", "page svelte-1rp6xr7");
			add_location(div2, file, 47, 0, 1263);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, meta, sections*/ 81922) {
...
function instance($$self, $$props, $$invalidate) {
	...
	const getComponent = () => async () => {
		...
		console.log({ meta });
		return await import('./index-fde6e3d5.js');
	};
...
//# sourceMappingURL=main-44f32300.js.map
