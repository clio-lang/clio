...
// (49:6) <Loadable loader={getComponent(meta)} let:component>
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(49:6) <Loadable loader={getComponent(meta)} let:component>",
		ctx
	});
...
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(48:4) <Route path=\\\"/*\\\" let:meta>",
		ctx
	});
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text(t0_value);
			t1 = space();
			add_location(h4, file, 62, 10, 1727);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(57:6) {#each sections as section}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(main, file, 46, 2, 1276);
			attr_dev(h3, "class", "svelte-1rp6xr7");
			add_location(h3, file, 55, 6, 1529);
			attr_dev(div0, "class", "sticky svelte-1rp6xr7");
			add_location(div0, file, 54, 4, 1502);
			attr_dev(div1, "class", "headnav svelte-1rp6xr7");
			add_location(div1, file, 53, 2, 1476);
			attr_dev(div2, "class", "page svelte-1rp6xr7");
			add_location(div2, file, 44, 0, 1210);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	const getComponent = () => async () => {
		const meta = await dynamicImport$1(`./meta/${currentVariant}.json`).default;
		console.log({ meta });
		return await import('./index-708de720.js');
	};
...
//# sourceMappingURL=main-3c16b824.js.map
