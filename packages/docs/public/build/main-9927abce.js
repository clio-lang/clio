...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text$1(t0_value);
			t1 = space$1();
			add_location$1(h4, file, 59, 10, 1584);
			...
			add_location$1(a, file, 54, 8, 1446);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location$1(main, file, 43, 2, 1133);
			attr_dev$1(h3, "class", "svelte-1rp6xr7");
			add_location$1(h3, file, 52, 6, 1386);
			attr_dev$1(div0, "class", "sticky svelte-1rp6xr7");
			add_location$1(div0, file, 51, 4, 1359);
			attr_dev$1(div1, "class", "headnav svelte-1rp6xr7");
			add_location$1(div1, file, 50, 2, 1333);
			attr_dev$1(div2, "class", "page svelte-1rp6xr7");
			add_location$1(div2, file, 41, 0, 1067);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	const getComponent = meta => async () => {
		return await import('./index-4cd5f907.js');
	};
...
//# sourceMappingURL=main-9927abce.js.map
