...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text$1(t0_value);
			t1 = space$1();
			add_location$1(h4, file, 61, 10, 1660);
			...
			add_location$1(a, file, 56, 8, 1522);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location$1(main, file, 45, 2, 1209);
			attr_dev$1(h3, "class", "svelte-1rp6xr7");
			add_location$1(h3, file, 54, 6, 1462);
			attr_dev$1(div0, "class", "sticky svelte-1rp6xr7");
			add_location$1(div0, file, 53, 4, 1435);
			attr_dev$1(div1, "class", "headnav svelte-1rp6xr7");
			add_location$1(div1, file, 52, 2, 1409);
			attr_dev$1(div2, "class", "page svelte-1rp6xr7");
			add_location$1(div2, file, 43, 0, 1143);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	const getComponent = () => async () => {
		const meta = await import('./v0.9.0-5200d30c.js');
		console.log({ meta });
		return await import('./index-98bbc049.js');
	};
...
//# sourceMappingURL=main-7b6c2b72.js.map
