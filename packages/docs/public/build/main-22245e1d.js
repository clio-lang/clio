...
function create_if_block(ctx) {
	...
	function switch_instance_sections_binding(value) {
		/*switch_instance_sections_binding*/ ctx[6](value);
	}
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text$1(t0_value);
			t1 = space$1();
			add_location$1(h4, file, 56, 10, 1424);
			...
			add_location$1(a, file, 51, 8, 1286);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	let if_block = component && create_if_block(ctx);
	...
	const block = {
		c: function create() {
			...
			add_location$1(main, file, 42, 2, 1066);
			attr_dev$1(h3, "class", "svelte-1rp6xr7");
			add_location$1(h3, file, 49, 6, 1226);
			attr_dev$1(div0, "class", "sticky svelte-1rp6xr7");
			add_location$1(div0, file, 48, 4, 1199);
			attr_dev$1(div1, "class", "headnav svelte-1rp6xr7");
			add_location$1(div1, file, 47, 2, 1173);
			attr_dev$1(div2, "class", "page svelte-1rp6xr7");
			add_location$1(div2, file, 40, 0, 1020);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (component) if_block.p(ctx, dirty);
...
function instance($$self, $$props, $$invalidate) {
	...
	const getComponent = meta => {
		return import('./index-eff738ea.js');
	};
...
//# sourceMappingURL=main-22245e1d.js.map
