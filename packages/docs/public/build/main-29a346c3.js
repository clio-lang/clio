...
function dynamicImport(path) {
  switch (path) {
    ...
    case "./routes/v0.9.0/index.svelte":
      return import('./index-57fab919.js');
  }
}
...
// (60:8) <Loadable loader={getComponent(meta)} let:component>
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(60:8) <Loadable loader={getComponent(meta)} let:component>",
		ctx
	});
...
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(58:4) <Route path=\\\"/*\\\" let:meta>",
		ctx
	});
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text(t0_value);
			t1 = space();
			add_location(h4, file, 74, 10, 2065);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(69:6) {#each sections as section}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(main, file, 56, 2, 1572);
			attr_dev(h3, "class", "svelte-1rp6xr7");
			add_location(h3, file, 67, 6, 1867);
			attr_dev(div0, "class", "sticky svelte-1rp6xr7");
			add_location(div0, file, 66, 4, 1840);
			attr_dev(div1, "class", "headnav svelte-1rp6xr7");
			add_location(div1, file, 65, 2, 1814);
			attr_dev(div2, "class", "page svelte-1rp6xr7");
			add_location(div2, file, 54, 0, 1506);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	const getComponent = meta => async () => {
		metaVariant.routes[currentVariant + meta.url];
...
//# sourceMappingURL=main-29a346c3.js.map
