...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text$1(t0_value);
			t1 = space$1();
			add_location$1(h4, file, 57, 10, 1474);
			...
			add_location$1(a, file, 52, 8, 1336);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location$1(main, file, 43, 2, 1099);
			attr_dev$1(h3, "class", "svelte-1rp6xr7");
			add_location$1(h3, file, 50, 6, 1276);
			attr_dev$1(div0, "class", "sticky svelte-1rp6xr7");
			add_location$1(div0, file, 49, 4, 1249);
			attr_dev$1(div1, "class", "headnav svelte-1rp6xr7");
			add_location$1(div1, file, 48, 2, 1223);
			attr_dev$1(div2, "class", "page svelte-1rp6xr7");
			add_location$1(div2, file, 41, 0, 1053);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	const getComponent = meta => () => {
		console.log({ meta });
		return import('./index-874847c5.js');
	};
...
//# sourceMappingURL=main-f54a7ba8.js.map
