...
function create_each_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location$1(option, file$1, 26, 8, 590);
		},
		m: function mount(target, anchor) {
			insert_dev$1(target, option, anchor);
			append_dev$1(option, t0);
			append_dev$1(option, t1);
		},
		p: function update(ctx, dirty) {
...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = space$1();
			create_component$1(sidenavitem.$$.fragment);
			attr_dev$1(select, "class", "svelte-1ya97bc");
			add_location$1(select, file$1, 24, 4, 539);
			attr_dev$1(div0, "class", "variants svelte-1ya97bc");
			add_location$1(div0, file$1, 23, 2, 512);
			attr_dev$1(div1, "class", "sidenav svelte-1ya97bc");
			toggle_class$1(div1, "open", /*menuOpen*/ ctx[1]);
			add_location$1(div1, file$1, 22, 0, 466);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		m: function mount(target, anchor) {
			...
			append_dev$1(div1, t);
			mount_component$1(sidenavitem, div1, null);
			current = true;
		},
		p: function update(ctx, [dirty]) {
		...
		i: function intro(local) {
			if (current) return;
			transition_in$1(sidenavitem.$$.fragment, local);
			current = true;
		},
		o: function outro(local) {
			transition_out$1(sidenavitem.$$.fragment, local);
			current = false;
		},
		d: function destroy(detaching) {
			if (detaching) detach_dev$1(div1);
			destroy_each$1(each_blocks, detaching);
			destroy_component$1(sidenavitem);
		}
	};
...
function instance$3($$self, $$props, $$invalidate) {
	let { $$slots: slots = {}, $$scope } = $$props;
	validate_slots$1("SideNav", slots, []);
	let { menuOpen } = $$props;
...
class SideNav extends SvelteComponentDev$1 {
	constructor(options) {
		super(options);
		init$1(this, options, instance$3, create_fragment$3, safe_not_equal$1, { menuOpen: 1, currentVariant: 0 });
...
// (48:6) <Loadable loader={getComponent(meta)} let:component>
function create_default_slot_1(ctx) {
	...
	dispatch_dev$1("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(48:6) <Loadable loader={getComponent(meta)} let:component>",
		ctx
	});
...
function create_default_slot(ctx) {
	...
	dispatch_dev$1("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(47:4) <Route path=\\\"/*\\\" let:meta>",
		ctx
	});
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text$1(t0_value);
			t1 = space$1();
			add_location$1(h4, file, 61, 10, 1679);
			...
			add_location$1(a, file, 56, 8, 1541);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev$1("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(56:6) {#each sections as section}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location$1(main, file, 45, 2, 1228);
			attr_dev$1(h3, "class", "svelte-1rp6xr7");
			add_location$1(h3, file, 54, 6, 1481);
			attr_dev$1(div0, "class", "sticky svelte-1rp6xr7");
			add_location$1(div0, file, 53, 4, 1454);
			attr_dev$1(div1, "class", "headnav svelte-1rp6xr7");
			add_location$1(div1, file, 52, 2, 1428);
			attr_dev$1(div2, "class", "page svelte-1rp6xr7");
			add_location$1(div2, file, 43, 0, 1162);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	const getComponent = () => async () => {
		const meta = await import(`./meta/${currentVariant}.json`).default;
		console.log({ meta });
		return await import('./index-4fb24c2a.js');
	};
...
//# sourceMappingURL=main-0cb80798.js.map
