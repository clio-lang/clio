...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text$1(t0_value);
			t1 = space$1();
			add_location$1(h4, file, 54, 10, 1405);
			...
			add_location$1(a, file, 49, 8, 1267);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location$1(h3, file, 47, 6, 1207);
			attr_dev$1(div0, "class", "sticky svelte-1rp6xr7");
			add_location$1(div0, file, 46, 4, 1180);
			attr_dev$1(div1, "class", "headnav svelte-1rp6xr7");
			add_location$1(div1, file, 45, 2, 1154);
...
function instance($$self, $$props, $$invalidate) {
	...
	const getComponent = meta => () => {
		return import('./index-9530c6b8.js');
	};
...
//# sourceMappingURL=main-1c2b7ee1.js.map
