...
function dynamicImport(path) {
  switch (path) {
    ...
    case "./routes/v0.9.0/index.svelte":
      return import('./index-e45da364.js');
  }
}
...
// (50:6) <Loadable loader={getComponent(meta)} let:component>
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(50:6) <Loadable loader={getComponent(meta)} let:component>",
		ctx
	});
...
function create_default_slot(ctx) {
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*$$scope, component, sections*/ 98305) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(49:4) <Route path=\\\"/*\\\" let:meta>",
		ctx
	});
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text(t0_value);
			t1 = space();
			add_location(h4, file, 63, 10, 1742);
		...
		p: function update(ctx, dirty) {
			if (dirty & /*sections*/ 1 && t0_value !== (t0_value = /*section*/ ctx[11] + "")) set_data_dev(t0, t0_value);

			if (dirty & /*sections*/ 1 && a_href_value !== (a_href_value = "#" + /*slug*/ ctx[5](/*section*/ ctx[11]))) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(58:6) {#each sections as section}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(main, file, 47, 2, 1291);
			attr_dev(h3, "class", "svelte-1rp6xr7");
			add_location(h3, file, 56, 6, 1544);
			attr_dev(div0, "class", "sticky svelte-1rp6xr7");
			add_location(div0, file, 55, 4, 1517);
			attr_dev(div1, "class", "headnav svelte-1rp6xr7");
			add_location(div1, file, 54, 2, 1491);
			attr_dev(div2, "class", "page svelte-1rp6xr7");
			add_location(div2, file, 45, 0, 1225);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, meta, sections*/ 81921) {
...
function instance($$self, $$props, $$invalidate) {
	...
	const getComponent = () => async () => {
		...
		console.log({ meta });
		return await import('./index-e45da364.js');
	};
...
//# sourceMappingURL=main-d1d1c085.js.map
