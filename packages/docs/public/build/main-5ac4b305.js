...
function set_store_value$1(store, ret, value = ret) {
    store.set(value);
    return ret;
}
...
function dispatch_dev$1(type, detail) {
    document.dispatchEvent(custom_event$1(type, Object.assign({ version: '3.38.2' }, detail)));
}
...
function create_each_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			option.selected = option_selected_value = /*variant*/ ctx[3] == /*currentVariant*/ ctx[1];
			add_location(option, file$1, 27, 8, 600);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			if (dirty & /*currentVariant*/ 2 && option_selected_value !== (option_selected_value = /*variant*/ ctx[3] == /*currentVariant*/ ctx[1])) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(27:6) {#each variants as variant}",
		ctx
	});
...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(select, file$1, 25, 4, 549);
			attr_dev(div0, "class", "variants svelte-1ya97bc");
			add_location(div0, file$1, 24, 2, 522);
			attr_dev(div1, "class", "sidenav svelte-1ya97bc");
			toggle_class(div1, "open", /*menuOpen*/ ctx[0]);
			add_location(div1, file$1, 23, 0, 476);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			if (dirty & /*variants, currentVariant*/ 2) {
				each_value = variants;
				validate_each_argument(each_value);
				let i;
...
function instance$3($$self, $$props, $$invalidate) {
	...
	let currentVariant = latestVariant;

	onMount(() => {
		$$invalidate(1, currentVariant = window.location.pathname.split("/").shift() || latestVariant);
	});
	...
	$$self.$inject_state = $$props => {
		if ("menuOpen" in $$props) $$invalidate(0, menuOpen = $$props.menuOpen);
		if ("currentVariant" in $$props) $$invalidate(1, currentVariant = $$props.currentVariant);
	};
	...
	return [menuOpen, currentVariant];
}

class SideNav extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$3, create_fragment$3, safe_not_equal, { menuOpen: 0 });
		...
		if (/*menuOpen*/ ctx[0] === undefined && !("menuOpen" in props)) {
...
function create_if_block_2(ctx) {
	...
	const loading_slot = create_slot$1(loading_slot_template, ctx, /*$$scope*/ ctx[10], get_loading_slot_context);
		...
		p: function update(ctx, dirty) {
			if (loading_slot) {
				if (loading_slot.p && (!current || dirty & /*$$scope, component*/ 1025)) {
					update_slot$1(loading_slot, loading_slot_template, ctx, /*$$scope*/ ctx[10], dirty, get_loading_slot_changes, get_loading_slot_context);
				}
			}
		},
		i: function intro(local) {
			if (current) return;
			transition_in$1(loading_slot, local);
			current = true;
		},
		o: function outro(local) {
			transition_out$1(loading_slot, local);
			current = false;
		},
		d: function destroy(detaching) {
...
function create_if_block_1(ctx) {
	...
	const timeout_slot = create_slot$1(timeout_slot_template, ctx, /*$$scope*/ ctx[10], get_timeout_slot_context);
		...
		p: function update(ctx, dirty) {
			if (timeout_slot) {
				if (timeout_slot.p && (!current || dirty & /*$$scope, component*/ 1025)) {
					update_slot$1(timeout_slot, timeout_slot_template, ctx, /*$$scope*/ ctx[10], dirty, get_timeout_slot_changes, get_timeout_slot_context);
				}
			}
		},
		i: function intro(local) {
			if (current) return;
			transition_in$1(timeout_slot, local);
			current = true;
		},
		o: function outro(local) {
			transition_out$1(timeout_slot, local);
			current = false;
		},
		d: function destroy(detaching) {
...
function create_if_block(ctx) {
	...
	const error_slot = create_slot$1(error_slot_template, ctx, /*$$scope*/ ctx[10], get_error_slot_context);
		...
		p: function update(ctx, dirty) {
			if (error_slot) {
				if (error_slot.p && (!current || dirty & /*$$scope, error, component*/ 1027)) {
					update_slot$1(error_slot, error_slot_template, ctx, /*$$scope*/ ctx[10], dirty, get_error_slot_changes, get_error_slot_context);
				}
			}
		},
		i: function intro(local) {
...
function create_if_block_5(ctx) {
	...
	const default_slot = create_slot$1(default_slot_template, ctx, /*$$scope*/ ctx[10], get_default_slot_context);
		...
		p: function update(ctx, dirty) {
			if (default_slot) {
				if (default_slot.p && (!current || dirty & /*$$scope, component*/ 1025)) {
					update_slot$1(default_slot, default_slot_template, ctx, /*$$scope*/ ctx[10], dirty, get_default_slot_changes, get_default_slot_context);
				}
			}
		},
		i: function intro(local) {
...
function create_if_block_4(ctx) {
	...
	const success_slot = create_slot$1(success_slot_template, ctx, /*$$scope*/ ctx[10], get_success_slot_context);
		...
		p: function update(ctx, dirty) {
			if (success_slot) {
				if (success_slot.p && (!current || dirty & /*$$scope, component*/ 1025)) {
					update_slot$1(success_slot, success_slot_template, ctx, /*$$scope*/ ctx[10], dirty, get_success_slot_changes, get_success_slot_context);
				}
			}
		},
		i: function intro(local) {
			if (current) return;
			transition_in$1(success_slot, local);
			current = true;
		},
		o: function outro(local) {
			transition_out$1(success_slot, local);
			current = false;
		},
		d: function destroy(detaching) {
...
function instance$1($$self, $$props, $$invalidate) {
	...
	validate_slots$1("Loadable", slots$1, ['error','timeout','loading','success','default']);
	let { delay = 200 } = $$props;
	...
	const capture = getContext$1("svelte-loadable-capture");
...
class Loadable extends SvelteComponentDev$1 {
	constructor(options) {
		super(options);
...
// (46:6) <Loadable loader={getComponent(meta)} let:component>
function create_default_slot_1(ctx) {
	...
	function switch_instance_sections_binding(value) {
		/*switch_instance_sections_binding*/ ctx[7](value);
	}
	...
	if (switch_value) {
		...
		binding_callbacks$1.push(() => bind(switch_instance, "sections", switch_instance_sections_binding));
	}
	...
	dispatch_dev$1("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(46:6) <Loadable loader={getComponent(meta)} let:component>",
		ctx
	});
...
function create_default_slot(ctx) {
	...
	loadable = new Loadable({
			props: {
				loader: /*getComponent*/ ctx[5](/*meta*/ ctx[12]),
				$$slots: {
					default: [
						create_default_slot_1,
						({ component }) => ({ 13: component }),
						({ component }) => component ? 8192 : 0
					]
				},
				$$scope: { ctx }
			},
	...
	const block = {
		c: function create() {
			create_component$1(loadable.$$.fragment);
		},
		m: function mount(target, anchor) {
			mount_component$1(loadable, target, anchor);
			current = true;
		},
		p: function update(ctx, dirty) {
			const loadable_changes = {};
			if (dirty & /*meta*/ 4096) loadable_changes.loader = /*getComponent*/ ctx[5](/*meta*/ ctx[12]);

			if (dirty & /*$$scope, component, sections*/ 24577) {
		...
		i: function intro(local) {
			if (current) return;
			transition_in$1(loadable.$$.fragment, local);
			current = true;
		},
		o: function outro(local) {
			transition_out$1(loadable.$$.fragment, local);
			current = false;
		},
		d: function destroy(detaching) {
			destroy_component$1(loadable, detaching);
		}
	};
	...
	dispatch_dev$1("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(45:4) <Route path=\\\"/*\\\" let:meta>",
		ctx
	});
...
// (54:6) {#each sections as section}
function create_each_block(ctx) {
	let a;
	let h4;
	let t0_value = /*section*/ ctx[9] + "";
	let t0;
	let t1;
	let a_href_value;
	...
	const block = {
		c: function create() {
			...
			t0 = text$1(t0_value);
			t1 = space$1();
			add_location$1(h4, file, 59, 10, 1552);
			attr_dev$1(a, "href", a_href_value = "#" + /*slug*/ ctx[4](/*section*/ ctx[9]));
			attr_dev$1(a, "tinro-ignore", "");
			attr_dev$1(a, "class", "svelte-1rp6xr7");
			toggle_class$1(a, "active", /*$currentSection*/ ctx[2] == /*slug*/ ctx[4](/*section*/ ctx[9]));
			add_location$1(a, file, 54, 8, 1414);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			if (dirty & /*sections*/ 1 && t0_value !== (t0_value = /*section*/ ctx[9] + "")) set_data_dev$1(t0, t0_value);

			if (dirty & /*sections*/ 1 && a_href_value !== (a_href_value = "#" + /*slug*/ ctx[4](/*section*/ ctx[9]))) {
				attr_dev$1(a, "href", a_href_value);
			}
	...
	dispatch_dev$1("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(54:6) {#each sections as section}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	function nav_menuOpen_binding(value) {
		/*nav_menuOpen_binding*/ ctx[6](value);
	}
	...
	binding_callbacks$1.push(() => bind(nav, "menuOpen", nav_menuOpen_binding));

	sidenav = new SideNav({
			props: { menuOpen: /*menuOpen*/ ctx[1] },
			$$inline: true
		});
	...
	const block = {
		c: function create() {
			...
			t0 = space$1();
			div2 = element$1("div");
			create_component$1(sidenav.$$.fragment);
			t1 = space$1();
			main = element$1("main");
			create_component$1(route.$$.fragment);
			t2 = space$1();
			div1 = element$1("div");
			div0 = element$1("div");
			h3 = element$1("h3");
			...
			attr_dev$1(main, "class", "svelte-1rp6xr7");
			add_location$1(main, file, 43, 2, 1101);
			attr_dev$1(h3, "class", "svelte-1rp6xr7");
			add_location$1(h3, file, 52, 6, 1354);
			attr_dev$1(div0, "class", "sticky svelte-1rp6xr7");
			add_location$1(div0, file, 51, 4, 1327);
			attr_dev$1(div1, "class", "headnav svelte-1rp6xr7");
			add_location$1(div1, file, 50, 2, 1301);
			attr_dev$1(div2, "class", "page svelte-1rp6xr7");
			add_location$1(div2, file, 41, 0, 1055);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		m: function mount(target, anchor) {
			...
			mount_component$1(sidenav, div2, null);
			append_dev$1(div2, t1);
			append_dev$1(div2, main);
			mount_component$1(route, main, null);
			append_dev$1(div2, t2);
			append_dev$1(div2, div1);
			append_dev$1(div1, div0);
			append_dev$1(div0, h3);
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, meta, sections*/ 20481) {
		...
		i: function intro(local) {
			...
			transition_in$1(sidenav.$$.fragment, local);
			transition_in$1(route.$$.fragment, local);
			current = true;
		},
		o: function outro(local) {
			transition_out$1(nav.$$.fragment, local);
			transition_out$1(sidenav.$$.fragment, local);
			transition_out$1(route.$$.fragment, local);
			current = false;
		},
		d: function destroy(detaching) {
			...
			destroy_component$1(sidenav);
			destroy_component$1(route);
...
function instance($$self, $$props, $$invalidate) {
	...
	validate_store$1(currentSection, "currentSection");
	component_subscribe$1($$self, currentSection, value => $$invalidate(2, $currentSection = value));
	setContext$1(keys.currentSection, currentSection);
	let sections = [];
	let menuOpen = false;
	let currentVariant = null;
	const slug = title => slugify(title).toLowerCase();

	const getComponent = meta => () => {
		return import('./index-4002bcd1.js');
	};
	...
	$$self.$inject_state = $$props => {
		...
		if ("menuOpen" in $$props) $$invalidate(1, menuOpen = $$props.menuOpen);
		if ("currentVariant" in $$props) currentVariant = $$props.currentVariant;
	};
...
export { globals as $, insert_dev$1 as A, group_outros$1 as B, check_outros$1 as C, detach_dev$1 as D, text$1 as E, append_dev$1 as F, action_destroyer as G, set_data_dev$1 as H, element as I, attr_dev as J, toggle_class as K, add_location as L, insert_dev as M, detach_dev as N, create_slot as O, update_slot as P, transition_in as Q, transition_out as R, SvelteComponentDev as S, commonjsGlobal as T, onMount as U, text as V, null_to_empty as W, append_dev as X, set_data_dev as Y, global$1 as Z, getAugmentedNamespace as _, SvelteComponentDev$1 as a, listen_dev as a0, space as a1, empty as a2, group_outros as a3, check_outros as a4, create_component as a5, mount_component as a6, destroy_component as a7, setContext as a8, tabsContext as a9, writable$1 as aa, getContext as ab, validate_store as ac, component_subscribe as ad, set_store_value as ae, set_style as af, app as ag, init$1 as b, safe_not_equal$1 as c, dispatch_dev as d, dispatch_dev$1 as e, validate_slots$1 as f, getContext$1 as g, validate_store$1 as h, init as i, component_subscribe$1 as j, keys as k, slugify as l, set_store_value$1 as m, noop as n, onMount$1 as o, create_component$1 as p, mount_component$1 as q, transition_out$1 as r, safe_not_equal as s, transition_in$1 as t, destroy_component$1 as u, validate_slots as v, space$1 as w, element$1 as x, attr_dev$1 as y, add_location$1 as z };
//# sourceMappingURL=main-5ac4b305.js.map
