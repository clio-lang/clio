...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text$1(t0_value);
			t1 = space$1();
			add_location$1(h4, file, 59, 10, 1572);
			attr_dev$1(a, "href", a_href_value = "#" + /*slug*/ ctx[5](/*section*/ ctx[10]));
			attr_dev$1(a, "tinro-ignore", "");
			attr_dev$1(a, "class", "svelte-1rp6xr7");
			toggle_class$1(a, "active", /*$currentSection*/ ctx[3] == /*slug*/ ctx[5](/*section*/ ctx[10]));
			add_location$1(a, file, 54, 8, 1434);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			if (dirty & /*sections*/ 1 && t0_value !== (t0_value = /*section*/ ctx[10] + "")) set_data_dev$1(t0, t0_value);
...
function create_fragment(ctx) {
	...
	binding_callbacks$1.push(() => bind(sidenav, "currentVariant", sidenav_currentVariant_binding));
	...
	const block = {
		c: function create() {
			...
			add_location$1(main, file, 43, 2, 1121);
			attr_dev$1(h3, "class", "svelte-1rp6xr7");
			add_location$1(h3, file, 52, 6, 1374);
			attr_dev$1(div0, "class", "sticky svelte-1rp6xr7");
			add_location$1(div0, file, 51, 4, 1347);
			attr_dev$1(div1, "class", "headnav svelte-1rp6xr7");
			add_location$1(div1, file, 50, 2, 1321);
...
function instance($$self, $$props, $$invalidate) {
	...
	component_subscribe$1($$self, currentSection, value => $$invalidate(3, $currentSection = value));
	...
	const getComponent = meta => () => {
		return import('./index-ff9d4857.js');
	};
...
//# sourceMappingURL=main-f709dd60.js.map
