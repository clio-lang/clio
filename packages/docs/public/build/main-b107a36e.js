...
// (45:6) <Loadable loader={getComponent(meta)} let:component>
function create_default_slot_1(ctx) {
	...
	dispatch_dev$1("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(45:6) <Loadable loader={getComponent(meta)} let:component>",
		ctx
	});
...
function create_default_slot(ctx) {
	...
	loadable = new Loadable({
			props: {
				loader: /*getComponent*/ ctx[5](/*meta*/ ctx[11]),
				$$slots: {
					default: [
						create_default_slot_1,
						({ component }) => ({ 12: component }),
						({ component }) => component ? 4096 : 0
					]
				},
				$$scope: { ctx }
			},
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*meta*/ 2048) loadable_changes.loader = /*getComponent*/ ctx[5](/*meta*/ ctx[11]);

			if (dirty & /*$$scope, component, sections*/ 12289) {
	...
	dispatch_dev$1("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(44:4) <Route path=\\\"/*\\\" let:meta>",
		ctx
	});
...
// (53:6) {#each sections as section}
function create_each_block(ctx) {
	let a;
	let h4;
	let t0_value = /*section*/ ctx[8] + "";
	let t0;
	let t1;
	let a_href_value;
	...
	const block = {
		c: function create() {
			...
			t0 = text$1(t0_value);
			t1 = space$1();
			add_location$1(h4, file, 58, 10, 1523);
			attr_dev$1(a, "href", a_href_value = "#" + /*slug*/ ctx[4](/*section*/ ctx[8]));
			attr_dev$1(a, "tinro-ignore", "");
			attr_dev$1(a, "class", "svelte-1rp6xr7");
			toggle_class$1(a, "active", /*$currentSection*/ ctx[2] == /*slug*/ ctx[4](/*section*/ ctx[8]));
			add_location$1(a, file, 53, 8, 1385);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			if (dirty & /*sections*/ 1 && t0_value !== (t0_value = /*section*/ ctx[8] + "")) set_data_dev$1(t0, t0_value);

			if (dirty & /*sections*/ 1 && a_href_value !== (a_href_value = "#" + /*slug*/ ctx[4](/*section*/ ctx[8]))) {
	...
	dispatch_dev$1("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(53:6) {#each sections as section}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location$1(main, file, 42, 2, 1072);
			attr_dev$1(h3, "class", "svelte-1rp6xr7");
			add_location$1(h3, file, 51, 6, 1325);
			attr_dev$1(div0, "class", "sticky svelte-1rp6xr7");
			add_location$1(div0, file, 50, 4, 1298);
			attr_dev$1(div1, "class", "headnav svelte-1rp6xr7");
			add_location$1(div1, file, 49, 2, 1272);
			attr_dev$1(div2, "class", "page svelte-1rp6xr7");
			add_location$1(div2, file, 40, 0, 1026);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, meta, sections*/ 10241) {
...
function instance($$self, $$props, $$invalidate) {
	...
	const getComponent = meta => () => {
		return import('./index-4d78e97f.js');
	};
...
export { getAugmentedNamespace as $, add_location$1 as A, insert_dev$1 as B, group_outros$1 as C, check_outros$1 as D, detach_dev$1 as E, text$1 as F, append_dev$1 as G, action_destroyer as H, set_data_dev$1 as I, element as J, attr_dev as K, toggle_class as L, add_location as M, insert_dev as N, detach_dev as O, create_slot as P, update_slot as Q, transition_in as R, SvelteComponentDev as S, transition_out as T, commonjsGlobal as U, onMount as V, text as W, null_to_empty as X, append_dev as Y, set_data_dev as Z, global$1 as _, SvelteComponentDev$1 as a, globals as a0, listen_dev as a1, space as a2, empty as a3, group_outros as a4, check_outros as a5, create_component as a6, mount_component as a7, destroy_component as a8, setContext as a9, tabsContext as aa, writable$1 as ab, getContext as ac, validate_store as ad, component_subscribe as ae, set_store_value as af, set_style as ag, app as ah, init$1 as b, safe_not_equal$1 as c, dispatch_dev as d, dispatch_dev$1 as e, validate_slots$1 as f, globals$1 as g, getContext$1 as h, init as i, validate_store$1 as j, keys as k, component_subscribe$1 as l, slugify as m, noop as n, onMount$1 as o, set_store_value$1 as p, create_component$1 as q, mount_component$1 as r, safe_not_equal as s, transition_in$1 as t, transition_out$1 as u, validate_slots as v, destroy_component$1 as w, space$1 as x, element$1 as y, attr_dev$1 as z };
//# sourceMappingURL=main-b107a36e.js.map
