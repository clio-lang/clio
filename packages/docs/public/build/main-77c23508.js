...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text$1(t0_value);
			t1 = space$1();
			add_location$1(h4, file, 54, 10, 1403);
			...
			add_location$1(a, file, 49, 8, 1265);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	var switch_value = /*getComponent*/ ctx[5]();
	...
	const block = {
		c: function create() {
			...
			add_location$1(h3, file, 47, 6, 1205);
			attr_dev$1(div0, "class", "sticky svelte-1rp6xr7");
			add_location$1(div0, file, 46, 4, 1178);
			attr_dev$1(div1, "class", "headnav svelte-1rp6xr7");
			add_location$1(div1, file, 45, 2, 1152);
		...
		m: function mount(target, anchor) {
			...
			if (switch_instance) {
				mount_component$1(switch_instance, main, null);
			}
		...
		p: function update(ctx, [dirty]) {
			...
			if (switch_value !== (switch_value = /*getComponent*/ ctx[5]())) {
				if (switch_instance) {
					group_outros$1();
					const old_component = switch_instance;
...
function instance($$self, $$props, $$invalidate) {
	...
	const getComponent = meta => () => {
		return import('./index-2a466519.js');
	};
...
//# sourceMappingURL=main-77c23508.js.map
