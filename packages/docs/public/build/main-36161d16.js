...
function dynamicImport(path) {
  switch (path) {
    ...
    case "./routes/v0.9.0/index.svelte":
      return import('./index-1c6abeb2.js');
  }
}
...
// (57:6) <Loadable loader={getComponent(meta)} let:component>
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(57:6) <Loadable loader={getComponent(meta)} let:component>",
		ctx
	});
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text(t0_value);
			t1 = space();
			add_location(h4, file, 70, 10, 1890);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(65:6) {#each sections as section}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h3, file, 63, 6, 1692);
			attr_dev(div0, "class", "sticky svelte-1rp6xr7");
			add_location(div0, file, 62, 4, 1665);
			attr_dev(div1, "class", "headnav svelte-1rp6xr7");
			add_location(div1, file, 61, 2, 1639);
...
//# sourceMappingURL=main-36161d16.js.map
