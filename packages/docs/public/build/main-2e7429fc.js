...
function dynamicImport(path) {
  switch (path) {
    ...
    case "./routes/v0.9.0/index.svelte":
      return import('./index-8cd774d7.js');
  }
}
...
function create_default_slot(ctx) {
	...
	loadable = new Loadable({
			props: {
				loader: /*getComponent*/ ctx[6](/*meta*/ ctx[15]),
				$$slots: {
					default: [
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*meta*/ 32768) loadable_changes.loader = /*getComponent*/ ctx[6](/*meta*/ ctx[15]);
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text(t0_value);
			t1 = space();
			add_location(h4, file, 72, 10, 1974);
			attr_dev(a, "href", a_href_value = "#" + /*slug*/ ctx[5](/*section*/ ctx[12]));
			attr_dev(a, "tinro-ignore", "");
			attr_dev(a, "class", "svelte-1rp6xr7");
			toggle_class(a, "active", /*$currentSection*/ ctx[3] == /*slug*/ ctx[5](/*section*/ ctx[12]));
			add_location(a, file, 67, 8, 1836);
		},
		m: function mount(target, anchor) {
			insert_dev(target, a, anchor);
			append_dev(a, h4);
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*sections*/ 2 && a_href_value !== (a_href_value = "#" + /*slug*/ ctx[5](/*section*/ ctx[12]))) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(main, file, 56, 2, 1523);
			attr_dev(h3, "class", "svelte-1rp6xr7");
			add_location(h3, file, 65, 6, 1776);
			attr_dev(div0, "class", "sticky svelte-1rp6xr7");
			add_location(div0, file, 64, 4, 1749);
			attr_dev(div1, "class", "headnav svelte-1rp6xr7");
			add_location(div1, file, 63, 2, 1723);
			attr_dev(div2, "class", "page svelte-1rp6xr7");
			add_location(div2, file, 54, 0, 1457);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, meta, sections*/ 163842) {
...
function instance($$self, $$props, $$invalidate) {
	...
	const getComponent = () => async () => {
		const { meta } = await dynamicImport(`./meta/${currentVariant}.json`);
		console.log({ meta });
		return await import('./index-8cd774d7.js');
	};
...
//# sourceMappingURL=main-2e7429fc.js.map
