...
function dynamicImport(path) {
  switch (path) {
    ...
    case "./routes/v0.9.0/index.svelte":
      return import('./index-790b6a4d.js');
  }
}
...
function create_if_block(ctx) {
	...
	loadable = new Loadable({
			props: {
				loader: /*getComponent*/ ctx[7](/*meta*/ ctx[15]),
				$$slots: {
					default: [
						create_default_slot_1,
						({ component }) => ({ 16: component }),
						({ component }) => component ? 65536 : 0
					]
				},
				$$scope: { ctx }
			},
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*meta*/ 32768) loadable_changes.loader = /*getComponent*/ ctx[7](/*meta*/ ctx[15]);

			if (dirty & /*$$scope, component, sections*/ 196610) {
...
// (61:8) <Loadable loader={getComponent(meta)} let:component>
function create_default_slot_1(ctx) {
	...
	function switch_instance_sections_binding(value) {
		/*switch_instance_sections_binding*/ ctx[10](value);
	}
	...
	function switch_props(ctx) {
		...
		if (/*sections*/ ctx[1] !== void 0) {
			switch_instance_props.sections = /*sections*/ ctx[1];
		}
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (!updating_sections && dirty & /*sections*/ 2) {
				updating_sections = true;
				switch_instance_changes.sections = /*sections*/ ctx[1];
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(61:8) <Loadable loader={getComponent(meta)} let:component>",
		ctx
	});
...
// (59:4) <Route path="/*" let:meta>
function create_default_slot(ctx) {
	let if_block_anchor;
	let current;
	let if_block = /*metaVariant*/ ctx[3] && create_if_block(ctx);
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			if (/*metaVariant*/ ctx[3]) {
				if (if_block) {
					if_block.p(ctx, dirty);

					if (dirty & /*metaVariant*/ 8) {
						transition_in(if_block, 1);
					}
				} else {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(59:4) <Route path=\\\"/*\\\" let:meta>",
		ctx
	});
...
// (70:6) {#each sections as section}
function create_each_block(ctx) {
	let a;
	let h4;
	let t0_value = /*section*/ ctx[12] + "";
	let t0;
	let t1;
	let a_href_value;
	...
	const block = {
		c: function create() {
			...
			t0 = text(t0_value);
			t1 = space();
			add_location(h4, file, 75, 10, 2099);
			attr_dev(a, "href", a_href_value = "#" + /*slug*/ ctx[6](/*section*/ ctx[12]));
			attr_dev(a, "tinro-ignore", "");
			attr_dev(a, "class", "svelte-1rp6xr7");
			toggle_class(a, "active", /*$currentSection*/ ctx[4] == /*slug*/ ctx[6](/*section*/ ctx[12]));
			add_location(a, file, 70, 8, 1961);
		},
		m: function mount(target, anchor) {
			insert_dev(target, a, anchor);
			append_dev(a, h4);
		...
		p: function update(ctx, dirty) {
			if (dirty & /*sections*/ 2 && t0_value !== (t0_value = /*section*/ ctx[12] + "")) set_data_dev(t0, t0_value);

			if (dirty & /*sections*/ 2 && a_href_value !== (a_href_value = "#" + /*slug*/ ctx[6](/*section*/ ctx[12]))) {
				attr_dev(a, "href", a_href_value);
			}

			if (dirty & /*$currentSection, slug, sections*/ 82) {
				toggle_class(a, "active", /*$currentSection*/ ctx[4] == /*slug*/ ctx[6](/*section*/ ctx[12]));
			}
		},
		d: function destroy(detaching) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(70:6) {#each sections as section}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	function nav_menuOpen_binding(value) {
		/*nav_menuOpen_binding*/ ctx[8](value);
	}

	let nav_props = {};

	if (/*menuOpen*/ ctx[2] !== void 0) {
		nav_props.menuOpen = /*menuOpen*/ ctx[2];
	}
	...
	function sidenav_currentVariant_binding(value) {
		/*sidenav_currentVariant_binding*/ ctx[9](value);
	}

	let sidenav_props = { menuOpen: /*menuOpen*/ ctx[2] };

	if (/*currentVariant*/ ctx[0] !== void 0) {
		sidenav_props.currentVariant = /*currentVariant*/ ctx[0];
	}
	...
	const block = {
		c: function create() {
			...
			add_location(main, file, 57, 2, 1606);
			attr_dev(h3, "class", "svelte-1rp6xr7");
			add_location(h3, file, 68, 6, 1901);
			attr_dev(div0, "class", "sticky svelte-1rp6xr7");
			add_location(div0, file, 67, 4, 1874);
			attr_dev(div1, "class", "headnav svelte-1rp6xr7");
			add_location(div1, file, 66, 2, 1848);
			attr_dev(div2, "class", "page svelte-1rp6xr7");
			add_location(div2, file, 55, 0, 1540);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (!updating_menuOpen && dirty & /*menuOpen*/ 4) {
				updating_menuOpen = true;
				nav_changes.menuOpen = /*menuOpen*/ ctx[2];
				add_flush_callback(() => updating_menuOpen = false);
			}

			nav.$set(nav_changes);
			const sidenav_changes = {};
			if (dirty & /*menuOpen*/ 4) sidenav_changes.menuOpen = /*menuOpen*/ ctx[2];

			if (!updating_currentVariant && dirty & /*currentVariant*/ 1) {
				updating_currentVariant = true;
				sidenav_changes.currentVariant = /*currentVariant*/ ctx[0];
			...
			if (dirty & /*$$scope, meta, sections, metaVariant*/ 163850) {
				route_changes.$$scope = { dirty, ctx };
			}

			route.$set(route_changes);

			if (dirty & /*slug, sections, $currentSection*/ 82) {
...
function instance($$self, $$props, $$invalidate) {
	...
	const setMetaVariant = variant => {
		if (variant) dynamicImport(`./meta/${variant}.json`).then(data => data.default).then(meta => $$invalidate(3, metaVariant = meta));
	};

	const slug = title => slugify(title).toLowerCase();

	const getComponent = meta => async () => {
		const url = currentVariant + meta.url.trimEnd("/");
		metaVariant.routes[url];
		console.log(metaVariant.routes, currentVariant + meta.url);
		return await dynamicImport(`./routes/${currentVariant}/index.svelte`);
	};

	onMount(() => {
		$$invalidate(2, menuOpen = window.innerWidth > 640);
	});
	...
	$$self.$inject_state = $$props => {
		...
		if ("currentVariant" in $$props) $$invalidate(0, currentVariant = $$props.currentVariant);
		if ("metaVariant" in $$props) $$invalidate(3, metaVariant = $$props.metaVariant);
	};
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*currentVariant*/ 1) {
...
//# sourceMappingURL=main-2731f414.js.map
