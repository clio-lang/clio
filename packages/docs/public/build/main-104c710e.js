...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text$1(t0_value);
			t1 = space$1();
			add_location$1(h4, file, 60, 10, 1609);
			...
			add_location$1(a, file, 55, 8, 1471);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location$1(main, file, 44, 2, 1158);
			attr_dev$1(h3, "class", "svelte-1rp6xr7");
			add_location$1(h3, file, 53, 6, 1411);
			attr_dev$1(div0, "class", "sticky svelte-1rp6xr7");
			add_location$1(div0, file, 52, 4, 1384);
			attr_dev$1(div1, "class", "headnav svelte-1rp6xr7");
			add_location$1(div1, file, 51, 2, 1358);
			attr_dev$1(div2, "class", "page svelte-1rp6xr7");
			add_location$1(div2, file, 42, 0, 1092);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	const getComponent = meta => () => {
		...
		return import('./index-05244ec4.js');
	};
...
//# sourceMappingURL=main-104c710e.js.map
