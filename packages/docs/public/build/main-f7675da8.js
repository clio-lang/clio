...
function dynamicImport(path) {
  switch (path) {
    ...
    case "./routes/v0.9.0/index.svelte":
      return import('./index-e4835da1.js');
  }
}
...
function instance($$self, $$props, $$invalidate) {
	...
	const getComponent = () => async () => {
		const meta = await dynamicImport(`./meta/${currentVariant}.json`).default;
		console.log({ meta });
		return await import('./index-e4835da1.js');
	};
...
//# sourceMappingURL=main-f7675da8.js.map
