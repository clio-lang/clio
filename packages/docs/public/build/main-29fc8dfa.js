...
function dynamicImport(path) {
  switch (path) {
    ...
    case "./routes/v0.9.0/index.svelte":
      return import('./index-e74276d6.js');
  }
}
...
// (58:8) <Loadable loader={getComponent(meta)} let:component>
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(58:8) <Loadable loader={getComponent(meta)} let:component>",
		ctx
	});
...
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(56:4) <Route path=\\\"/*\\\" let:meta>",
		ctx
	});
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text(t0_value);
			t1 = space();
			add_location(h4, file, 72, 10, 1932);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(67:6) {#each sections as section}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(main, file, 54, 2, 1439);
			attr_dev(h3, "class", "svelte-1rp6xr7");
			add_location(h3, file, 65, 6, 1734);
			attr_dev(div0, "class", "sticky svelte-1rp6xr7");
			add_location(div0, file, 64, 4, 1707);
			attr_dev(div1, "class", "headnav svelte-1rp6xr7");
			add_location(div1, file, 63, 2, 1681);
			attr_dev(div2, "class", "page svelte-1rp6xr7");
			add_location(div2, file, 52, 0, 1373);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=main-29fc8dfa.js.map
