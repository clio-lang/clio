...
function dynamicImport(path) {
  switch (path) {
    ...
    case "./routes/v0.9.0/index.svelte":
      return import('./index-140d08af.js');
  }
}
...
// (59:6) <Loadable loader={getComponent(meta)} let:component>
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(59:6) <Loadable loader={getComponent(meta)} let:component>",
		ctx
	});
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text(t0_value);
			t1 = space();
			add_location(h4, file, 72, 10, 1939);
...
function instance($$self, $$props, $$invalidate) {
	...
	const setMetaVariant = variant => {
		if (variant) dynamicImport(`./meta/${variant}.json`).then(data => data.default).then(meta => metaVariant = meta).then(() => ready = true);
	};
...
//# sourceMappingURL=main-5a58e14c.js.map
