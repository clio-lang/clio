...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text(t0_value);
			t1 = space();
			add_location(h4, file, 64, 10, 1705);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(main, file, 48, 2, 1254);
			attr_dev(h3, "class", "svelte-1rp6xr7");
			add_location(h3, file, 57, 6, 1507);
			attr_dev(div0, "class", "sticky svelte-1rp6xr7");
			add_location(div0, file, 56, 4, 1480);
			attr_dev(div1, "class", "headnav svelte-1rp6xr7");
			add_location(div1, file, 55, 2, 1454);
			attr_dev(div2, "class", "page svelte-1rp6xr7");
			add_location(div2, file, 46, 0, 1188);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	{
		import('./v0.9.0-5200d30c.js');
	}

	const getComponent = () => async () => {
		await import(`./meta/${currentVariant}.json`).default;
		return await import('./index-5c7835b5.js');
	};
...
//# sourceMappingURL=main-c2080068.js.map
