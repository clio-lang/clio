...
const matchers = {
  ...
  list: function(i, tokens, parser) {
    return helpers.isWrappedRepeat(
      "lbra",
      "rbra",
      [
  ...
  math: function(i, tokens, parser) {
    return helpers.isOneOf(tokens[i], ["dsop_math", "sop_math", "op_math"])
      ? i + 1
      : -1;
  },
  ...
  event: function(i, tokens) {
    return helpers.isSeq(
      [
        ...
        { name: "colon", count: 1 },
        {
          name: ["symbol", "string", "word", "property_access", "slice"],
          count: 1
        }
      ],
      i,
  ...
  decorator: function(i, tokens) {
    return helpers.isSeq(
      [
        ...
        { name: "_", count: 1, opt: true },
        {
          name: ["symbol", "property_access", "number", "list"],
          sep: ["_"],
          count: 0,
          enders: ["_n"],
          opt: true
  ...
  halfnot: function(i, tokens) {
    return helpers.isSeq([{ name: "not", count: 1 }], i, tokens);
  },
